...
![Структура проекта](./structure.jpg)
...
![Контейнеры Docker](./containers.jpg)
...
![Генерация IoT-событий](./generating.jpg)
...
![Справочник типов устройств](./id-device.jpg)
...
![Сырые события в Kafka](./kafka.jpg)
...
![Схема выполнения Flink job](./schema.jpg)
...
![Статусы операторов Flink job](./status.jpg)
...
![Окна и агрегаты в Kafka](./kafka_windows.jpg)
...
![Чтение агрегированного потока](./listening.jpg)
